(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-basic-login-basic-login-module"], {
    /***/
    "7yM0": function yM0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var BasicLoginComponent = /*#__PURE__*/function () {
        function BasicLoginComponent(auth, formBuilder, route, router) {
          ...
          value: function onSubmit() {
            ...
            try {
              var _this$loginForm$value = this.loginForm.value,
                  ...
                  password = _this$loginForm$value.password; //this.loading = true;
      ...
      BasicLoginComponent.ɵfac = function BasicLoginComponent_Factory(t) {
        return new (t || BasicLoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_0__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };

      BasicLoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: BasicLoginComponent,
        selectors: [["app-basic-login"]],
        decls: 35,
        vars: 1,
        consts: [[1, "login", "p-fixed", "d-flex", "text-center", "bg-primary", "common-img-bg"], [1, "auth-fluid"], [1, "row"], [1, "col-sm-12"], [1, "login-card", "card-body", "auth-body"], [1, "md-float-material", 3, "formGroup", "ngSubmit"], [1, "text-center"], ["src", "assets/images/auth/logo-dark.png", "alt", "logo.png"], [1, "auth-box"], [1, "row", "m-b-20"], [1, "col-md-12"], [1, "text-left", "txt-primary"], [1, "input-group"], ["type", "email", "formControlName", "email", "placeholder", "Your Email Address", 1, "form-control"], [1, "md-line"], ["type", "password", "formControlName", "password", "placeholder", "Password", 1, "form-control"], [1, "row", "m-t-25", "text-left"], [1, "col-sm-7", "col-xs-12"], [1, "checkbox-fade", "fade-in-primary"], ["type", "checkbox", "value", ""], [1, "cr"], [1, "cr-icon", "icofont", "icofont-ui-check", "txt-primary"], [1, "text-inverse"], [1, "col-sm-5", "col-xs-12", "forgot-phone", "text-right"], [1, "row", "m-t-30"], ["type", "submit", 1, "btn", "btn-primary", "btn-md", "btn-block", "waves-effect", "text-center", "m-b-20"]],
        template: function BasicLoginComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngSubmit", function BasicLoginComponent_Template_form_ngSubmit_5_listener() {
              return ctx.onSubmit();
            });
    ...
    /***/
    "Cyoc": function Cyoc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _basic_login_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      BasicLoginModule.ɵfac = function BasicLoginModule_Factory(t) {
        return new (t || BasicLoginModule)();
      };

      BasicLoginModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineNgModule"]({
        type: BasicLoginModule
      });
      BasicLoginModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _basic_login_routing_module__WEBPACK_IMPORTED_MODULE_2__["BasicLoginRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](BasicLoginModule, {
          declarations: [_basic_login_component__WEBPACK_IMPORTED_MODULE_1__["BasicLoginComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _basic_login_routing_module__WEBPACK_IMPORTED_MODULE_2__["BasicLoginRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]]
        });
      })();
      /***/
    ...
    /***/
    "Nao/": function Nao(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      BasicLoginRoutingModule.ɵfac = function BasicLoginRoutingModule_Factory(t) {
        return new (t || BasicLoginRoutingModule)();
      };

      BasicLoginRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: BasicLoginRoutingModule
      });
      BasicLoginRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](BasicLoginRoutingModule, {
